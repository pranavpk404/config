...
def config_system():
    theme_input = input("For Catppuccin:1 | For Gruvbox:2 | For Nord:3 | For Rose Pine:4 | For Dracula:5 | For Ayu:6 || Default is Ayu\n")
    if theme_input == "1":
        theme = "catppuccin"
    elif theme_input == "2":
        theme = "gruvbox"
...
def shell():
    ...
    if zsh_or_fish == "1":
        ...
        system("git clone https://github.com/zdharma-continuum/fast-syntax-highlighting.git ${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}/plugins/fast-syntax-highlighting")    
        system("git clone https://github.com/zsh-users/zsh-autosuggestions ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/plugins/zsh-autosuggestions")
        system("git clone https://github.com/zsh-users/zsh-completions ${ZSH_CUSTOM:-${ZSH:-~/.oh-my-zsh}/custom}/plugins/zsh-completions")
...
user_input = input("For Aur Programs:1 | For config:2 | For shell:3 | For Everything:4\n")
